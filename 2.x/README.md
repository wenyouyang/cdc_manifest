CDCBase Manifest for development of release-Branch 2.x
======================================================

This folder contains the manifests for the development of CDCBase release-Branch 2.x.
...
**Sync Instructions**
    ...
    mkdir cdcbase
    cd cdcbase
    repo init -u ssh://stash.alm.mentorg.com:7999/cdcbase/cdcbase-manifests.git -b master -m 2.x/cdcbase.xml -g <Manifest-Group>,default
