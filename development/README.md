CDCBase Manifest for development
================================

This folder contains the manifests for the development of CDCBase.
...
**Sync Instructions**
    ...
    mkdir cdcbase
    cd cdcbase
    repo init -u ssh://stash.alm.mentorg.com:7999/cdcbase/cdcbase-manifests.git -b master -m development/cdcbase.xml -g <Manifest-Group>,default
