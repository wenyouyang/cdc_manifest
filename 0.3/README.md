CDCBase Manifest for release 0.3
================================

This folder contains the manifests of CDCBase release 0.3.
...
**Sync Instructions**
    ...
    mkdir cdcbase
    cd cdcbase
    repo init -u ssh://stash.alm.mentorg.com:7999/cdcbase/cdcbase-manifests.git -b master -m 0.3/cdcbase.xml -g <Manifest-Group>,default
