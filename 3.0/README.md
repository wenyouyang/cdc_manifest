CDCBase Manifest for release 3.0
================================

This folder contains the manifests of CDCBase release 3.0.
...
**Sync Instructions**
    ...
    mkdir cdcbase
    cd cdcbase
    repo init -u ssh://stash.alm.mentorg.com:7999/cdcbase/cdcbase-manifests.git -b master -m 3.0/cdcbase.xml -g <Manifest-Group>,default
