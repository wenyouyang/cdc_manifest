CDCBase Manifest for release 0.2
================================

This folder contains the manifests of CDCBase release 0.2.
...
**Sync Instructions**
    ...
    mkdir cdcbase
    cd cdcbase
    repo init -u ssh://stash.alm.mentorg.com:7999/cdcbase/cdcbase-manifests.git -b master -m 0.2/cdcbase.xml -g <Manifest-Group>,default
